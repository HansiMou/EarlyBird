...
$w = system("cd /web/hm1305/fclp; /usr/bin/java -Dfile.encoding=UTF-8 -cp '.:lib/lucene-core-5.4.1.jar:lib/lucene-analyzers-common-5.4.1.jar:lib/lucene-queryparser-5.4.1.jar:lib/lucene-highlighter-5.4.1.jar:lib/lucene-join-5.4.1.jar:lib/lucene-memory-5.4.1.jar:class/' Searcher \"".$_POST['query'] . "\"",$res);
echo '</div>
